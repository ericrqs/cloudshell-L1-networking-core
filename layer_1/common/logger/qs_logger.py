...
import os
import re
from layer_1.common.logger.interprocess_logger import MultiProcessingLog
from layer_1.common.logger.qs_config_parser import QSConfigParser
...
def get_accessible_log_path(reservation_id='Autoload', handler='default', log_folder=None):
...
def _create_logger(log_group, log_category, log_file_prefix, log_folder):
    ...
    log_path = get_accessible_log_path(log_group, log_file_prefix, log_folder)
